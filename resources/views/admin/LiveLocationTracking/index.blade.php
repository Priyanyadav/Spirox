    ...
    <div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
        <div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center">
                <a href="{{ route('admin.livelocationtracking.create') }}" data-title="Create"
...
@push('script-push')
    <script>
        $(document).on("submit", "#livelocationtrackingForm", async function(e) {
            e.preventDefault();
        ...
        $(function() {
            ...
            var dtable = $('#table').DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.livelocationtracking.index') }}",
                    data: function(d) {
